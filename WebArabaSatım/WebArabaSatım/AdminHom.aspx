<%@ Page Title="" Language="C#" MasterPageFile="~/AdminLeyout.Master" AutoEventWireup="true" CodeBehind="AdminHom.aspx.cs" Inherits="WebArabaSatım.AdminHom" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      <form ID="form1" cssClass="Warning" runat="server">
          <asp:DataList ID="DataList" CssClass="datalist" runat="server">
                   <ItemTemplate>
                    ...
                    <tr>
                     ...
                     <tr>
                        <td>
                            ...
                            <asp:TextBox ID="Label8" runat="server"  CssClass="Contact" ForeColor="Black" ReadOnly="True"  Text='<%# Eval("CarContact") %>' />
